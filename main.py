...
if __name__ == "__main__":
    ...
    ejecutar_simulacion(tipo_mapa=1, algoritmo_str="BFS", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=1, algoritmo_str="Dijkstra", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=1, algoritmo_str="A*", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=1, algoritmo_str="Greedy", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=1, algoritmo_str="Genetico", num_iteraciones=200)
    print(f"Pruebas de simulacion mapa 2")
    ejecutar_simulacion(tipo_mapa=2, algoritmo_str="BFS", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=2, algoritmo_str="Dijkstra", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=2, algoritmo_str="A*", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=2, algoritmo_str="Greedy", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=2, algoritmo_str="Genetico", num_iteraciones=200)
    print(f"Pruebas de simulacion mapa 3")
    ejecutar_simulacion(tipo_mapa=3, algoritmo_str="BFS", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=3, algoritmo_str="Dijkstra", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=3, algoritmo_str="A*", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=3, algoritmo_str="Greedy", num_iteraciones=200)
    ejecutar_simulacion(tipo_mapa=3, algoritmo_str="Genetico", num_iteraciones=200)
